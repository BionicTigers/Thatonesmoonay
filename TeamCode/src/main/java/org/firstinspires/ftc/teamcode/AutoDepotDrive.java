...
//          Start lift down motors(2) go down, need method (note to self), reverse one motor
            ...
            //all//
            nav.pointTurn(110f); //get off hook by going to the front
            sleep(100);
            nav.pointTurn(0f); //turn back to straighten self out
            sleep(100);
            nav.pointTurn(ralph);
            ...
            sleep(100);
            nav.pointTurn(turnLeft1); //turn left to face wall
            sleep(100);
            nav.goDistance(-43f); // drive towards wall and get close enough to it
            sleep(100);
            nav.pointTurn(rotate); //turn right to face depot and square up with wall
            sleep(100);
